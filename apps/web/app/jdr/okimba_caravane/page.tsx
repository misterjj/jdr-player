    ...
    tabs: [
        ...
        },
        {
            ...
            narrator: [
                ...
                {
                    name: "Le Village Pikpik",
                    description: "",
                    image: "https://placehold.co/100x100?text=05",
                    file: assetsPath + "/sound/act-III/5.wav",
                },
                {
                    name: "La Grande Fresque",
                    description: "",
                    image: "https://placehold.co/100x100?text=06",
                    file: assetsPath + "/sound/act-III/6.wav",
                },
                {
                    name: "L'attaque des krakoss",
                    description: "",
                    image: "https://placehold.co/100x100?text=07",
                    file: assetsPath + "/sound/act-III/7.wav",
                },
                {
                    name: "La maladie de la mâchoire",
                    description: "Chambre des malades",
                    image: "https://placehold.co/100x100?text=08",
                    file: assetsPath + "/sound/act-III/8.wav",
                },
                {
                    name: "La Corniche",
                    description: "",
                    image: "https://placehold.co/100x100?text=09",
                    file: assetsPath + "/sound/act-III/9.wav",
                },
                {
                    name: "Gransek, le doyen du monde",
                    description: "",
                    image: "https://placehold.co/100x100?text=10",
